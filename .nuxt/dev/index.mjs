...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/admin/Desktop/radixhr-website/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/admin/Desktop/radixhr-website/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/admin/Desktop/radixhr-website/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/admin/Desktop/radixhr-website/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/admin/Desktop/radixhr-website","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/admin/Desktop/radixhr-website/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/admin/Desktop/radixhr-website/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/admin/Desktop/radixhr-website/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/admin/Desktop/radixhr-website/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _MoDtVrQ5su = (function(nitro) {
...
const _Sb1v8XGKs4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_iQRQxY = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_b5wn2m = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_7b0Dev = () => Promise.resolve().then(function () { return user$1; });
const _lazy_IKRYqh = () => Promise.resolve().then(function () { return hello$1; });
const _lazy_axnrO0 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/login', handler: _lazy_iQRQxY, lazy: true, middleware: false, method: "post" },
  { route: '/api/register', handler: _lazy_b5wn2m, lazy: true, middleware: false, method: "post" },
  { route: '/api/user', handler: _lazy_7b0Dev, lazy: true, middleware: false, method: undefined },
  { route: '/hello', handler: _lazy_IKRYqh, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_axnrO0, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_axnrO0, lazy: true, middleware: false, method: undefined }
];
...
const login_post = defineEventHandler((event) => {
  console.log(event);
  return {
    hello: "world"
  };
...
const register_post = defineEventHandler((event) => {
  console.log(event);
  return {
    hello: "world"
  };
...
const hello = defineEventHandler(() => "Hello World from routes folder");
...
const getClientManifest = () => import('file:///Users/admin/Desktop/radixhr-website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/admin/Desktop/radixhr-website/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
